...
const Create = () => {
    ...
    function handleSubmit(e) {
        ...
        setTimeout(() => {
            post('/users');
            setIsSubmitting(false); // Reset the submitting state after the post
        }, 3000);
    }
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-8">
                ...
                <div className="mb-6 mt-4">
                    <button 
                        ...
                        className={`bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 ${processing || isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        Submit
                    </button>
                </div>
